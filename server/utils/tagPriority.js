...
// love(1) > like(2) > meh(3) > pass(4)

export const TAG_PRIORITY = { love: 1, like: 2, meh: 3, pass: 4 };
...
export function tagPrioritySQL(column = 'tag') {
  return `CASE ${column} WHEN 'love' THEN 1 WHEN 'like' THEN 2 WHEN 'meh' THEN 3 WHEN 'pass' THEN 4 END`;
}
